  ...
  function _populatejobs(jobs, startIndex) {
    ...
    for (let ctr = startIndex; ctr < startIndex + 6; ctr += 1) {
      ...
      if (jobs[ctr].Account__c === currentCompany) {
        jobButton = `<a href="/job-requirement/${jobs[ctr].Id}" target="_blank"><button class="job-apply-btn">Edit</button></a> <a href="/applicant-list/${jobs[ctr].Id}" target="_blank"><button class="job-apply-btn">View Applicants</button></a>`;
      } else {
